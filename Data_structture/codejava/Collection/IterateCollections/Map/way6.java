...
public class way6 {
    public static void main(String[] args){
        ...
        for(Iterator<Map.Entry<String,Integer>> it1 = markmath.entrySet().iterator(); it1.hasNext();){
            Map.Entry<String, Integer> w1 = it1.next() ;
            System.out.println("+"+w1.getKey()+" : "+w1.getValue()) ;
            System.out.println();
        }
        ...
        for(Iterator<Map.Entry<Integer, String>> it2 = listofstudent.entrySet().iterator(); it2.hasNext();){
            Map.Entry<Integer,String> w2 = it2.next() ;
        ...
        for(Iterator<Map.Entry<String,String>> it3 = typeofconduct.entrySet().iterator(); it3.hasNext();){
            Map.Entry<String, String> w3 = it3.next() ;
            System.out.println("+"+w3.getKey()+" : "+w3.getValue()) ;
            System.out.println();
        }
    }
}
