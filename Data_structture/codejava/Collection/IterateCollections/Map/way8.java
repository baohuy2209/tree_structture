...
public class way8 {
    public static void main(String[] args){
        ...
        markmath.entrySet().stream().parallel().forEach(e1 -> System.out.println("+"+e1.getKey()+" : "+e1.getValue()));
        ...
        listofstudent.entrySet().stream().parallel().forEach(e2 -> System.out.println("+"+e2.getKey()+" : "+e2.getValue()));
        ...
        typeofconduct.entrySet().stream().parallel().forEach(e3 -> System.out.println("+"+e3.getKey()+" : "+e3.getValue()));
    }
}
