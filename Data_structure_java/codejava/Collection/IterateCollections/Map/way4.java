...
public class way4 {
    public static void main(String[] args){
        ...
        for(String key: markmath.keySet()){
            System.out.println("+ "+key+" : "+markmath.get(key)) ;
            System.out.println(" ") ;
        }
        ...
        for(Integer key: listofstudent.keySet()){
            System.out.println("+ "+key+" : "+listofstudent.get(key)) ;
            System.out.println(" ") ;
        }
        ...
        for(String key: typeofconduct.keySet()){
            System.out.println("+ "+key+" : "+typeofconduct.get(key)) ;
            System.out.println(" ") ;
        }
        System.out.println(" ") ;
    }
