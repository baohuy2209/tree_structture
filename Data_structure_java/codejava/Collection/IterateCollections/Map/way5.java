...
public class way5 {
    public static void main(String[] args){
        ...
        Iterator<String> it1 = markmath.keySet().iterator() ;
        while(it1.hasNext()){
            String w1 = it1.next() ;
            System.out.println("+"+w1+" : "+markmath.get(w1)) ;
            System.out.println(" ") ;
        }
        ...
        Iterator<Integer> it2 = listofstudent.keySet().iterator() ;
        while(it2.hasNext()){
            Integer w2 = it2.next() ;
            System.out.println("+"+w2+")"+listofstudent.get(w2)) ;
            System.out.println(" ") ;
        }
        ...
        Iterator<String> it3 = typeofconduct.keySet().iterator() ;
        while(it3.hasNext()) {
            String w3 = it3.next() ;
            System.out.println("+" + w3 + " : " + typeofconduct.get(w3));
            System.out.println(" ") ;
        }
    }
}
